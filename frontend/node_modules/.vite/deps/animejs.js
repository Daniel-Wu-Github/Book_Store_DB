    ...
    if (shouldSeek) {
      ...
      if (syncSmooth && isNum(syncSmooth)) {
        if (
          ...
          const step = 1e-4;
          const snap3 = lp < p && p === 1 ? step : lp > p && !p ? -step : 0;
...
var debugColors2 = { line: "#00D672", word: "#FF4B4B", char: "#5A87FF" };
...
var processHTMLTemplate = (htmlTemplate, store, node, $parentFragment, type, debug, lineIndex, wordIndex, charIndex) => {
  ...
  if (debug) $highestParent.style.outline = `1px dotted ${debugColors2[type]}`;
...
export {
  ...
  lerp2 as lerp,
  linear,
  mapRange2 as mapRange,
  morphTo,
  onScroll,
  padEnd2 as padEnd,
  padStart2 as padStart,
